...
class Checkpointer(object):
    ...
    def load(self, f=None, use_latest=True, model_only=False):
        ...
        if "model_cdb" in checkpoint and self.model_cdb:
            ...
            print("Loading model_cdb from {}".format(f))
    ...
    def load_optimizer(self, checkpoint):
        if "optimizer" in checkpoint and self.optimizer:
            ...
            raise Exception('"optimizer" not in "checkpoint" or Checkpointer has no optimizer!')
        ...
        if "optimizer_cdb" in checkpoint and self.optimizer_cdb:
            ...
            raise Exception('"optimizer_cdb" not in "checkpoint" or Checkpointer has no optimizer_cdb!')
        return checkpoint

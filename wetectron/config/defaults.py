...
_C.MODEL.ROI_WEAK_HEAD.PSEUDO_LABEL_GENERATOR = "mist_layer"
_C.MODEL.ROI_WEAK_HEAD.OICR_P = 0.15
_C.MODEL.ROI_WEAK_HEAD.REGRESS_ON = False
_C.MODEL.ROI_WEAK_HEAD.REGRESS_HEUR = "AVG"
# For active samples
_C.MODEL.ROI_WEAK_HEAD.ACTIVE_LOSS = None
_C.MODEL.ROI_WEAK_HEAD.ACTIVE_PSEUDO_LOSS = None
_C.MODEL.ROI_WEAK_HEAD.ACTIVE_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_WEAK_HEAD.CYCLE_LOSS_SC = False
# for partial labels
...
# TRAINLOG_PERIOD controls the frequency of logs
# If set to -1, logs happen every 20*iter_size
_C.SOLVER.TRAINLOG_PERIOD = -1
...
# Return also losses?
_C.TEST.RETURN_LOSS = False
_C.TEST.RETURN_SCORE = False # Always False, to remove (needed for compatibility with old exps)

# Concatenate all test datasets to one?
_C.TEST.CONCAT_DATASETS = False

# visualization threshold
_C.TEST.VIS_THRES = 0.5

#
_C.TEST.REMOVE_IMAGES_WITHOUT_ANNOTATIONS = False
_C.TEST.RUN_EVALUATION = True
...
_C.ACTIVE = CN()
_C.ACTIVE.LOSS = CN()
_C.ACTIVE.LOSS.USE_INSTANCE_WEIGHT = False
_C.ACTIVE.LOSS.STRONG_LOSS_ON_MIL = True
_C.ACTIVE.INPUT_FILE = None
_C.ACTIVE.PSEUDO_BOXES_FILE = None
_C.ACTIVE.GO_THROUGH_CDB = True

# Sampling scheme
_C.ACTIVE.WEIGHTED_SAMPLING = False
_C.ACTIVE.ACTIVE_SAMPLE_RATIO = 0.5
# Use only images with full supervision
_C.ACTIVE.BATCH_ONLY_FULLY_SUP = False

# Sampling scheme for pseudo-gt
_C.ACTIVE.PSEUDO_WEIGHTED_SAMPLING = False
# Use only images with full supervision
_C.ACTIVE.PSEUDO_BATCH_ONLY_PSEUDO = False

_C.ACTIVE.WEIGHTED_PROPOSAL_SUBSAMPLE = False

# Losses weights
_C.ACTIVE.WEIGHTS_BBX_LOSS = 1.0
_C.ACTIVE.IMG_STRONG_DET_WEIGHT = 1.0

# DEPRECATED
_C.SOLVER.LAST_EPOCH = -1
_C.SOLVER.INITIAL_LR = 0.0001

_C.WEAK_INSTANCE_WEIGHT_FILE = None
_C.WEAK_WEIGHTED_SAMPLING = False

# Debug 
_C.DEBUG = CN()
_C.DEBUG.LOG_ACTIVE_IMAGE_NAME = False
_C.DEBUG.LOG_ACTIVE_SAMPLES_INFO = False
_C.DEBUG.LOG_PSEUDO_BOXES_INFO = False
...
class WeightedDistributedSampler(DistributedSampler):
    """
    A modified version of DistributedSampler to take into account the diffierent
    sampling weights of datapoints.
    """
    def __init__(self, dataset, weights, num_replicas=None, rank=None, shuffle=True):
        super(WeightedDistributedSampler, self).__init__(
                dataset, num_replicas=None, rank=None, shuffle=True
            )

...
class FastRCNNLossComputation(object):
    ...
    def subsample(self, proposals, targets, sampling_weights=None):
        ...
        Arguments:
            ...
            sampling_weights (list[tensor] or None): sampling weights of negative proposals
        """
        labels, regression_targets = self.prepare_targets(proposals, targets)
        sampled_pos_inds, sampled_neg_inds = self.fg_bg_sampler(labels, sampling_weights)
